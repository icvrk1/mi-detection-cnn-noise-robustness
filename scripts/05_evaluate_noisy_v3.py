"""
Evaluacija V3 modela (trening sa augmentacijom suma) na svim zasumljenim
varijantama test skupa. Koristi iste NPZ fajlove kao V1 evaluacija.

Ucitava prag odluke iz outputs/reports/threshold_tuning_v3.json ako postoji,
inace koristi podrazumijevani prag 0.5.

Sprema:
  outputs/reports/eval_noisy_v3.json
  outputs/tables/results_noisy_v3.csv
"""
